	...
	Set<Jugador> jugadores = new HashSet<Jugador>();
	     ...
	     if(res.equals(si)){
	      ...
	      try{
     		...
     		if (nivel==3) {
     			System.out.println("*                                            *");
     			System.out.println("*  ¿Desea cambiar de escenario?              *");
     			String respuesta3 = sc.nextLine();
     			
         		if(respuesta3.equals(si)){
         			System.out.println("*                                            *");
         			System.out.println("*         Cambiando de Escenario...          *");
         			System.out.println("*                                            *");
         			
     				m.getGUI().borrar();
         			m.getGUI().addImagen("estrellas4.jpg", new Rectangulo(new Coordenada (0,0),500,500));
