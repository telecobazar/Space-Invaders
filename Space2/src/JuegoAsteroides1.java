...
public static void main (String[] args) {
	...
	Set<Jugador> jugadores = new HashSet<Jugador>();
     			...
     			for(Jugador j : jugadores){
     				...
     				while(i.hasNext()){
	     				if(contador>3){
	     					if((i!=null)){
	     						System.out.println("*                                            *");
		     					System.out.println("* No hay mas de 3 puntuaciones guardadas     *");
		     					System.out.println("*                                            *");
	  ...
	  System.out.println("Desea almacenar la lista de jugadores actual?");
	  ...
	  if(sc.nextLine().equals(si)){
		  ...
		  System.out.println("* Esperamos que haya disfrutado con el juego *");
		  System.exit(0);
	  }
	}
}
